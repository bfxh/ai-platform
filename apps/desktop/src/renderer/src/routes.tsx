    ...
    children: [
      { index: true, element: null },
      {
        ...
        children: [
          ...
          { path: "issues", element: <IssuesPage />, handle: { title: t("Issues") } },
          {
            path: "issues/:id",
            element: <IssueDetailPage />,
            handle: { title: t("Issue") },
          },
          {
            path: "projects",
            element: <ProjectsPage />,
            handle: { title: t("Projects") },
          },
          {
            path: "projects/:id",
            element: <ProjectDetailPage />,
            handle: { title: t("Project") },
          },
          {
            path: "autopilots",
            element: <AutopilotsPage />,
            handle: { title: t("Autopilot") },
          },
          {
            path: "autopilots/:id",
          ...
          },
          {
            ...
            handle: { title: t("My Issues") },
          },
          {
            path: "runtimes",
            element: <DesktopRuntimesPage />,
            handle: { title: t("Runtimes") },
          },
          {
            path: "runtimes/:id",
            element: <RuntimeDetailPage />,
            handle: { title: t("Runtime") },
          },
          { path: "skills", element: <SkillsPage />, handle: { title: t("Skills") } },
          {
            path: "skills/:id",
            element: <SkillDetailPage />,
            handle: { title: t("Skill") },
          },
          { path: "agents", element: <AgentsPage />, handle: { title: t("Agents") } },
          {
            path: "agents/:id",
            element: <AgentDetailPage />,
            handle: { title: t("Agent") },
          },
          { path: "inbox", element: <InboxPage />, handle: { title: t("Inbox") } },
          {
            path: "settings",
            element: (
              <SettingsPage
