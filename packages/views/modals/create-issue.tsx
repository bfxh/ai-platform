        ...
        {backlogHintIssueId ? (
          ...
          <>
            ...
            <IssuePickerModal
              ...
              title={t("Set parent issue")}
              description={t("Search for an issue to set as the parent of the new issue")}
              excludeIds={[
            ...
            <IssuePickerModal
              ...
              title={t("Add sub-issue")}
              description={t("Search for an issue to add as a sub-issue of the new issue")}
              excludeIds={[
                ...childIssues.map((c) => c.id),
                ...(parentIssueId ? [parentIssueId] : []),
              ]}
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t shrink-0">
              ...
              <Button size="sm" onClick={handleSubmit} disabled={!title.trim() || submitting}>
                {submitting ? t("Creating...") : t("Create Issue")}
              </Button>
            </div>
          </>
        )}
