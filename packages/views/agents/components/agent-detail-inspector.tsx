  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col overflow-y-auto rounded-lg border bg-background">
      ...
      <Section label={t("Properties")}>
        <PropRow label={t("Runtime")} interactive={false}>
          <RuntimePicker
        ...
        <PropRow label={t("Model")} interactive={false}>
          <ModelPicker
        ...
        <PropRow label={t("Visibility")} interactive={false}>
          <VisibilityPicker
            value={agent.visibility}
            onChange={(v) => update({ visibility: v })}
          />
        </PropRow>
        <PropRow label={t("Concurrency")} interactive={false}>
          <ConcurrencyPicker
      ...
      <Section label={t("Details")}>
        {owner && (
          <PropRow label={t("Owner")} interactive={false}>
        ...
        <PropRow label={t("Created")} interactive={false}>
          <span className="text-muted-foreground">
            {timeAgo(agent.created_at)}
          </span>
        </PropRow>
        <PropRow label={t("Updated")} interactive={false}>
          <span className="text-muted-foreground">
