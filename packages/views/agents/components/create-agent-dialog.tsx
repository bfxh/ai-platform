  ...
  return (
    <Dialog open onOpenChange={(v) => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            {isDuplicate ? t("Duplicate Agent") : t("Create Agent")}
          </DialogTitle>
          <DialogDescription>
            {isDuplicate
        ...
        <div className="space-y-4 min-w-0">
          <div>
            ...
            <Input
              ...
              placeholder={t("e.g. Deep Research Agent")}
              className="mt-1"
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <span className="truncate font-medium">
                      {runtimesLoading ? t("Loading runtimes...") : (selectedRuntime?.name ?? t("No runtime available"))}
                    </span>
                  ...
                  <div className="truncate text-xs text-muted-foreground">
                    {selectedRuntime
                      ...
                      : t("Register a runtime before creating an agent")}
                  </div>
                </div>
