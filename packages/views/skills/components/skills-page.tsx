...
function ListColumnHeader() {
  return (
    ...
    >
      ...
      <span className="hidden md:block">{t("Source · Added by")}</span>
      <span className="hidden md:block">{t("Updated")}</span>
      <span className="w-4" />
    </div>
  );
}
  ...
  return (
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-sm font-medium">{t("Skills")}</h1>
        {totalCount > 0 && (
...
function EmptyState({ onCreate }: { onCreate: () => void }) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <h2 className="mt-4 text-base font-semibold">{t("No skills yet")}</h2>
          ...
          <div className="flex flex-1 min-h-0 flex-col overflow-hidden rounded-lg border bg-background">
            ...
            {filtered.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4 py-16 text-center text-muted-foreground">
                ...
                <p className="text-sm">{t("No matches")}</p>
