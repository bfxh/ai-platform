    ...
    return (
      <div className="flex flex-1 min-h-0 flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-2 text-center">
          ...
          <p className="text-sm font-medium">{t("Skill not found")}</p>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {canEdit && (
            <Tooltip>
              ...
              />
              <TooltipContent>{t("Delete skill")}</TooltipContent>
            </Tooltip>
          )}
        </div>
      </div>
          ...
          <div className="flex h-10 shrink-0 items-center justify-between border-b px-3">
            ...
            {canEdit && (
              <Tooltip>
                ...
                />
                <TooltipContent>{t("Add file")}</TooltipContent>
              </Tooltip>
            )}
          </div>
          {addingFile && (
          ...
          <div className="space-y-2 border-b px-5 py-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                placeholder={t("One sentence describing when an agent should use this skill…")}
                rows={2}
        ...
        <aside className="flex w-72 shrink-0 flex-col gap-4 overflow-y-auto border-l bg-muted/20 px-4 py-4">
          <div>
            ...
            <dl className="space-y-1.5 text-xs">
              ...
              {creator && (
                <div className="flex gap-2">
                  <dt className="min-w-20 text-muted-foreground">{t("Created by")}</dt>
                  <dd className="min-w-0 flex-1">{creator.name}</dd>
                </div>
              )}
              <div className="flex gap-2">
                <dt className="min-w-20 text-muted-foreground">{t("Files")}</dt>
