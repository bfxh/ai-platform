    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        {detailsOpen && <div className="space-y-0.5 pl-2">
          ...
          <PropRow label={t("Created")}>
            <span className="text-muted-foreground">{shortDate(issue.created_at)}</span>
          </PropRow>
          <PropRow label={t("Updated")}>
        ...
        <PageHeader className="gap-2 bg-background text-sm">
          ...
          <div className="flex items-center gap-1 shrink-0">
            <Tooltip>
              ...
              />
              <TooltipContent side="bottom">{actions.isPinned ? t("Unpin from sidebar") : t("Pin to sidebar")}</TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              ...
              />
              <TooltipContent side="bottom">{t("Toggle sidebar")}</TooltipContent>
            </Tooltip>
          </div>
        </PageHeader>
              ...
              <div className="mt-10">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Tooltip>
                    ...
                    />
                    <TooltipContent side="bottom">{t("Add sub-issue")}</TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Popover>
                  ...
                  <PopoverContent align="end" className="w-64 p-0">
                    <Command>
                      <CommandInput placeholder={t("Change subscribers...")} />
