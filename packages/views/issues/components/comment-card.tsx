    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {hasReplies
              ? t("This comment and all its replies will be permanently deleted. This cannot be undone.")
              : t("This comment will be permanently deleted. This cannot be undone.")}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
        ...
        >
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" variant="outline" onClick={saveEdit}>{t("Save")}</Button>
            </div>
          </div>
