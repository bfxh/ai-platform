            ...
            <div className="mt-10 flex flex-col gap-7">
              ...
              >
                ...
                <OtherOptionCard
                  ...
                  placeholder={t("e.g. a small community I help run")}
                />
              </QuestionBlock>
              ...
              >
                ...
                <OtherOptionCard
                  ...
                  placeholder={t("e.g. researcher, designer, ops lead")}
                />
              </QuestionBlock>
              ...
              >
                ...
                <OtherOptionCard
                  ...
                  placeholder={t("e.g. automate my weekly reports")}
                />
              </QuestionBlock>
            </div>
          </div>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4">
          <UnlockItem
            ...
            title={t("A starter project, tailored")}
            body="A Getting Started checklist shaped by your answers."
          />
          <UnlockItem
            icon={<Sparkles className="h-4 w-4" />}
            title={t("A head start with agents")}
