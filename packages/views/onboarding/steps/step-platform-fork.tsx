        ...
        >
          <div className="mx-auto w-full max-w-[620px] px-6 py-10 sm:px-10 md:px-14 lg:px-0 lg:py-14">
            ...
            <div className="mt-10 flex max-w-[560px] flex-col gap-3.5">
              ...
              <ForkAlt
                title={t("Cloud runtime")}
                subtitle={t("We host the runtime. Not live yet — join the waitlist.")}
                actionLabel={
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => (o ? null : onClose())}>
      ...
      <DialogContent className="flex max-h-[85vh] flex-col sm:max-w-[560px]">
        <DialogHeader>
          <DialogTitle>{t("Install the CLI")}</DialogTitle>
          <DialogDescription>
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => (o ? null : onClose())}>
      <DialogContent className="flex max-h-[85vh] flex-col sm:max-w-[520px]">
        <DialogHeader>
          <DialogTitle>{t("Join the cloud runtime waitlist")}</DialogTitle>
          <DialogDescription>
