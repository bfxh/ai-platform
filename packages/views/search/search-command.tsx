...
import { t,  useWorkspaceId  } from "@multica/core";
...
const navPages: NavPage[] = [
  { key: "inbox", label: t("Inbox"), icon: Inbox, keywords: ["inbox", "notifications"] },
  { key: "myIssues", label: t("My Issues"), icon: CircleUser, keywords: ["my", "issues", "assigned"] },
  { key: "issues", label: t("Issues"), icon: ListTodo, keywords: ["issues", "tasks", "bugs"] },
  { key: "projects", label: t("Projects"), icon: FolderKanban, keywords: ["projects", "kanban"] },
  { key: "agents", label: t("Agents"), icon: Bot, keywords: ["agents", "bots", "ai"] },
  { key: "runtimes", label: t("Runtimes"), icon: Monitor, keywords: ["runtimes", "environments"] },
  { key: "skills", label: t("Skills"), icon: BookOpenText, keywords: ["skills", "library"] },
  { key: "settings", label: t("Settings"), icon: Settings, keywords: ["settings", "config", "preferences"] },
];
