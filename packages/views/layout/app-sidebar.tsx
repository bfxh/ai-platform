...
// (e.g. t("Projects") stays lit on /:slug/projects/:id). Pinned items keep
                  ...
                  return (
                    <SidebarMenuItem key={item.key}>
                      ...
                      >
                        ...
                        {item.label === t("Inbox") && unreadCount > 0 && (
                  ...
                  return (
                    <SidebarMenuItem key={item.key}>
                      ...
                      >
                        <item.icon />
                        <span>{item.label}</span>
                        {item.label === t("Runtimes") && hasRuntimeUpdates && (
