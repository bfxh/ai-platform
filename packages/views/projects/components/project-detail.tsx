  ...
  const handleMoveIssue = useCallback(
    (issueId: string, newStatus: IssueStatus, newPosition?: number) => {
      ...
      updateIssueMutation.mutate(
        { id: issueId, ...updates },
        { onError: () => toast.error(t("Failed to move issue")) },
      );
    },
    [updateIssueMutation],
  );
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t("This will delete the project. Issues will not be deleted but will be unlinked.")}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
