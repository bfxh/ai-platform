    ...
    <div className="rounded-lg border bg-card p-4">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <h4 className="text-sm font-semibold">{t("When this runtime spent")}</h4>
          <Segmented
            value={tab}
            onChange={setTab}
            options={
  ...
  return (
    <div className="rounded-lg border">
      <div className="grid grid-cols-[100px_1fr_80px_80px_80px_80px] gap-2 border-b px-3 py-2 text-xs font-medium text-muted-foreground">
        ...
        <div className="text-right">{t("Cache R")}</div>
        <div className="text-right">{t("Cache W")}</div>
      </div>
...
function UsageEmpty() {
  return (
    <div className="flex flex-col items-center rounded-lg border border-dashed py-8">
      ...
      <p className="mt-2 text-xs text-muted-foreground">{t("No usage data yet")}</p>
    </div>
  );
}
